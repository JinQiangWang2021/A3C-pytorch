...
from algorithm.agent_a3c import A3C
...
if __name__ == "__main__":
    ...
    # a3c_mCar,score = train_agent_for_env("Pendulum-v0", True)
    agent,score = train_agent_for_env("Hopper-v2", True)

    # a3c_mCar = train_agent_for_env("Hopper-v2", True)
    plot_scores(score,"cartPole_trainPlot.png")
